...
public class FriendsRequestTemplate extends EmailBaseTemplate {
    ...
    public static String friendRequestSent(String senderName, String receiverName, Optional<String> ctaUrl) {
        ...
        String mainContent = String.format(
                "<strong>%s</strong> quiere ser tu amigo en CineClub+. ¡Acepta la solicitud para ver qué películas tienen en común!",
                senderName
        );
    ...
    public static String friendRequestAccepted(String senderName, String receiverName, Optional<String> ctaUrl) {
        ...
        String mainContent = String.format(
                "<strong>%s</strong> ha aceptado tu solicitud. ¡Genial! Ahora pueden compartir recomendaciones y ver sus colecciones.",
                receiverName
        );
