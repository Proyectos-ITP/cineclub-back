        ...
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("""
                                ...
                                <img id="zoom-img" 
                                        src="/diagram.svg" 
                                        style="transform-origin: top left; transition: transform 0.15s ease; min-width: 1000px; display: block;" />
                                </div>
                        ...
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("Equipo Cineclub")
                                .email("soporte@cineclub.com")))
                .addServersItem(new Server()
                        .url(serverUrl.equals("http://localhost") ? "http://localhost:" + serverPort : serverUrl)
                        .description(serverUrl.equals("http://localhost") ? "Servidor de desarrollo local" : "Servidor de producción"))
