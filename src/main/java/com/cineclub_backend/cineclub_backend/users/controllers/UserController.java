...
public class UserController {
    ...
    @GetMapping("/")
    @Operation(summary = "Listar todos los usuarios", description = "Obtiene la lista completa de usuarios sin paginación")
    public List<User> getAllUsers() {
        return crudUserService.getAllUsers();
    }

    @GetMapping("/paginated")
    @Operation(summary = "Listar usuarios paginados", description = "Obtiene la lista de usuarios de forma paginada con filtros opcionales")
